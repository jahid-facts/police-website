...
export default function SubTitle({ titleId }) {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-sub-title/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const submitData = (e) => {
        ...
        const formData = {
            ...
            titleId: Number(categoryData.pageId), // Updated to use 'pageId'
        ...
        if (categoryData.id) {
            http.put(`update-sub-title/${categoryData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setPagesData({ title: "", titleId: "" });
            ...
            http.post('create-sub-title', formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setContent("");
...
//         const formData = {
//             title: categoryData.title,
//             titleId: Number(categoryData.titleId),
//             index: Number(categoryData.index),
//             // status: status,
//         }
