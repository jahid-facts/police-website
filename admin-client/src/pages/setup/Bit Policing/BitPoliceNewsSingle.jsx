...
export default function BitPoliceNewsSingle() {
    ...
    useEffect(() => {
        ...
        http
            .get(`bit-news-by-officer/${user?.permissions}`)
            .then((res) => {
                setData(res.data)
                setSpinner(false);
            })
    ...
    const submitData = (e) => {
        ...
        formData.append("officerId", user.permissions);
                    ...
                    <div className="page-content">
                        ...
                        <div className=" p-3">
                            <form onSubmit={submitData}>
                                ...
                                <select disabled name="officerId" onChange={handleChange} value={user.permissions} className="form-control form-control-sm my-2" required>
